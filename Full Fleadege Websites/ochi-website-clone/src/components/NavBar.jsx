...
{
    return (
        <header className='w-full px-20 font-[NeueMontreal] py-8 z-20 flex justify-between items-center'>
            <div className="logo">
            ...
            <nav className="links flex items-center justify-between flex-wrap">
                {["Services", "Our Work", "About Us", "Insights"].map((item, index) =>
                {
                    return (
                        <a key={index} href="#" className="text-md font-semibold text-white hover:text-zinc-300 mr-6">
                            {item}
                        </a>
                    )
                })}
            ...
            <div className="contact">
                <a href="#" className="text-md font-semibold text-white hover:text-zinc-300">Contact Us</a>
            </div>
        </header>
    )
}
